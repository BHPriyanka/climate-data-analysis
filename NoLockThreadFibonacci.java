...
/*
 * NoLockThreadFibonacci extends Thread class and computes Average TMAX temperatures for each stationID 
 ...
 */
public class NoLockThreadFibonacci extends Thread {
	public final static Logger logger = Logger.getLogger(NoLockThreadFibonacci.class.getName());
	 ...
	 */
	NoLockThreadFibonacci(String threadname, List<String> records, int low, int high, HashMap<String,StationAvgTempEntry> stationAvgTemp) {
