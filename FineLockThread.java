...
/*
 * FineLockThread extends Thread class and computes Average TMAX temperatures for each stationID 
 * of the parsed data and accumulates the results in the shared data structure stationAvgTemp
 * with the fine lock feature being implemented
 */
public class FineLockThread extends Thread {
	public final static Logger logger = Logger.getLogger(FineLockThread.class.getName());
	 ...
	 */
	FineLockThread(String threadname, List<String> records, int low, int high, ConcurrentHashMap<String, StationAvgTempEntry> stationAvgTemp) {
		name = threadname;
