...
/*
 * NoShareThreadFibonacci extends Thread class and computes Average TMAX temperatures for each stationID 
 ...
 */
public class NoShareThreadFibonacci extends Thread {
	public final static Logger logger = Logger.getLogger(NoShareThreadFibonacci.class.getName());
	 ...
	 */
	NoShareThreadFibonacci(String threadname, List<String> records, int low, int high) {
